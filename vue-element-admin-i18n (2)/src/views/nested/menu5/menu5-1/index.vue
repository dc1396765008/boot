...
<!-- 	table: {
      ...
      <el-table-column :label="$t('ID')"  prop="id"  align="center"  min-width="6%" :class-name="getSortClass('id')" >
       ...
       <el-table-column :label="$t('table.shopName')" min-width="15%" align="center">
        ...
        <el-table-column :label="$t('table.imageLink')" min-width="23%" align="center">
             <template slot-scope="{row}">
       ...
       <el-table-column :label="$t('table.commodityLink')" min-width="20%" align="center">
        ...
        <el-table-column :label="$t('table.productName')" min-width="16%" align="center">
             <template slot-scope="{row}">
        ...
        <el-table-column :label="$t('table.evaluationTheNumber')" min-width="10%" align="center">
             <template slot-scope="{row}">
               <span >{{ row.evaluationTheNumber }}</span>
             </template>
           </el-table-column>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['ID', '店铺名称', '图片链接', '商品链接', '商品名称', '价格', '评论数']
        const filterVal = ['id', 'shopName', 'imageLink', 'commodityLink', 'productName', 'price', 'evaluationTheNumber']
